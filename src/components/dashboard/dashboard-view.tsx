...
export function DashboardView() {
  ...
  // Today's events (calendar_event type with schedule today)
  ...
  // Today's todos (not completed, due today)
                ...
                <div
                  ...
                  style={{
                    borderLeftColor: evt.schedule
                      ? getColor(evt.schedule.category, document.documentElement.classList.contains('dark'))
                      : undefined,
                  }}
                >
